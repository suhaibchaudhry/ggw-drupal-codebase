 ...
 */
$db_url = 'mysqli://ggw_import1:xyz786@localhost/ggw_import1';
$db_prefix = '';

$conf['cache_inc'] ='sites/all/modules/memcache/memcache.inc';
$conf['memcache_key_prefix'] ='ggw-production';

if($_SERVER['HTTP_HOST'] == 'pos.general-goods.com' || $_SERVER['HTTP_HOST'] == 'pos.general-goods.com:7000') {
	$db_url = 'mysqli://ggw:xyz786@localhost/ggw';
	$conf['memcache_key_prefix'] ='ggw-base';
}

if($_SERVER['HTTP_HOST'] == 'test.general-goods.com' || $_SERVER['HTTP_HOST'] == 'test.general-goods.com:7000') {
	$db_url = 'mysqli://ggw_test:xyz786@localhost/ggw_test';
	$conf['memcache_key_prefix'] ='ggw-test';
}
...
$conf['locale_custom_strings_en'] = array(
	...
	'A message will be included in the order if this is checked.' => 'Price will be not be shown on the shipped invoice.',
	'Postal code' => 'Zip Code',
	'UberPOS' => 'Point of Sale',
	'UberPOS interface.' => 'Point of Sale interface.',
	'SKU' => 'Carton Barcode',
	'Product SKU/model.' => '',
	'Administer' => 'Back Office',
	'Username' => 'Account ID',
	'Orders' => 'Tickets',
	'View and process orders.' => 'View and process tickets.',
	'Order ID' => 'Ticket ID',
	'Purchase date' => 'Open Date',
	'Add to cart' => 'Add to List',
	'View orders' => 'View Tickets',
	'Create order' => 'Create Ticket',
	'Search orders' => 'Search Ticket',
	'Update cart' => 'Update List',
	'Order on UberPOS.' => 'Order on POS.',
	'UberPOS Screen' => 'POS Screen',
	'UberPOS Buttons' => 'POS Buttons',
	'UberPOS button' => 'POS button',
	'UberPOS Interface' => 'POS Interface',
	'MEMBER' => 'CUSTOMER',
	'Store administration' => 'Warehouse Management',
	'Administer store settings, products, orders, and more.' => 'Perform common every day management tasks.',
	'Request new password' => 'Forgot Password?',
	'Shopping cart' => 'Order List',
	'There are no products in your shopping cart.' => 'There are no items in your order list.',
	'Store settings' => 'Location settings',
	'Store e-mail address is set.' => 'Location e-mail is set.',
	'Product image support has been automatically configured by Ubercart.' => 'Product images are properly configured.',
	'Store status' => 'Technical Check',
	'<strong>@product-title</strong> added to <a href="!url">your shopping cart</a>.' => '<strong>@product-title</strong> added to <a href="!url">your order list</a>.',
	'Publishing options' => 'Availability',
	'Published' => 'Active',
	'Various reports generated by Ubercart modules can be found here. Click the links below to view the reports.' => ''
);
